...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.email.includes('yopmail') || formData.email.includes('maildrop') || formData.email.includes('burnermail') || formData.email.includes('sharklasers') || formData.email.includes('guerrillamail') || formData.email.includes('grr') || formData.email.includes('pokemail') || formData.email.includes('spam4')) {
  ...
  //if these exact words are present in the email filed, then set the error to  "We do not support disposable email services"
  if (formData.email.includes('yopmail') || formData.email.includes('maildrop') || formData.email.includes('burnermail') || formData.email.includes('sharklasers') || formData.email.includes('guerrillamail') || formData.email.includes('grr') || formData.email.includes('pokemail') || formData.email.includes('spam4')) {
    setErrors({ email: 'We do not support disposable email services' })
    return
  }
